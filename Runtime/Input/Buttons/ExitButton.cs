...
namespace Input.Buttons
{
    ...
    public class ExitButton: MonoBehaviour, ISelectable
    {
        ...
        private void TryActivate()
        {
            ...
            IModuleStateSystem moduleStateSystem = MemoreCoreApplication.Container.Resolve<IModuleStateSystem>();
            moduleStateSystem.PopModuleState();
        }
